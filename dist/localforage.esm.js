...
function setItem$2(originalKey, value, callback) {
    var self = this;

    key$2 = normalizeKey(originalKey);
...
function removeItem$2(originalKey, callback) {
    var self = this;
...
export { localforage as default };
//# sourceMappingURL=localforage.esm.js.map
